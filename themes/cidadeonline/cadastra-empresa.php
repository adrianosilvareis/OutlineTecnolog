            ...
            <div class="label_line">
                <label class="label_small">
                    ...
                    <select class="j_loadstate" name="empresa_uf">
                        ...
                        <?php
                        $readState = new Controle('app_estados');
                        $readState->FullRead("SELECT * FROM app_estados ORDER BY estado_nome ASC");
                ...
                <label class="label_small">
                    ...
                    <select class="j_loadcity" name="empresa_cidade">
                        <?php if (!isset($data['empresa_cidade'])): ?>
                            ...
                            $City->Query("#estado_id# ORDER BY cidade_nome ASC", "estado_id={$data['empresa_uf']}");
                            if ($City->getRowCount()):
